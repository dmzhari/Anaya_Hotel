...
<div class="container mt-2">
    <!-- <button class="btn btn-secondary mt-3 form-control" onclick="add_modal_pelanggan()">Tambah Pesanan</button> -->
                        ...
                        <tbody>
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="#" data-id="" class="btn btn-success mb-2" onClick="show_modal_reservasi(this.id)" id="<?php echo $row["id"]; ?>">Lihat</a>
                                            <a href="#" data-id="" class="btn btn-primary mb-2" onClick="check_modal_reservasi(this.id)" id="<?php echo $row["id"]; ?>">Proses</a>
                                            <a href="#" data-id="" class="btn btn-danger" onClick="delete_modal_reservasi(this.id)" id="<?php echo $row["id"]; ?>">Hapus</a>
                                        </td>
                                    </tr>
                            <?php
                                }
...
<script type="text/javascript">
    ...
    function add_modal_pelanggan() {
        $.ajax({
            url: "proses/tambah_pelanngan.php",
    ...
    function show_modal_reservasi(id) {
        ...
        $.ajax({
            url: "../resepsionis/proses/tampil_pelanngan.php",
            method: "GET",
            data: {
                idp: id
            },
    ...
    function delete_modal_reservasi(id) {
        $.ajax({
            url: "../proses/delete_pelanngan.php",
            method: "POST",
            data: {
                idp: id
            },
    ...
    $('#carinama').keyup(function() {
        ...
        $.ajax({
            url: "../resepsionis/proses/cari_nama.php",
            method: "POST",
            data: {
                kata: kata
            },
    ...
    $(document).ready(function() {
        ...
        $("#tgl").on("change", function() {
            ...
            $.ajax({
                url: "../resepsionis/proses/cari_tanggal.php",
                method: "POST",
                data: {
                    tanggal: tanggal
                },
