...
$id			 	 = htmlspecialchars($conn->real_escape_string($_POST['idfk']));
...
$gambar		 	 = htmlspecialchars($conn->real_escape_string($_POST['gambar']));
...
if ($gambar != "") {
	if ($_FILES["edit_foto"]["name"] != '') {
		...
		$sql = "UPDATE tb_fasilitas_kamar SET id_kamar ='$idkamar', 
