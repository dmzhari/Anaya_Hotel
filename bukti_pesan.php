...
$jkamar     = htmlspecialchars(mysqli_real_escape_string($conn, $_GET['jk']));
$nama       = htmlspecialchars(mysqli_real_escape_string($conn, $_GET['nama']));
$email      = htmlspecialchars(mysqli_real_escape_string($conn, $_GET['email']));
$checkin    = htmlspecialchars(mysqli_real_escape_string($conn, $_GET['tm']));
$checkout   = htmlspecialchars(mysqli_real_escape_string($conn, $_GET['tk']));
